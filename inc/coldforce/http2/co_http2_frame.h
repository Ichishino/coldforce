...
#define CO_HTTP2_SETTINGS_HEADER_TABLE_SIZE         1
#define CO_HTTP2_SETTINGS_ENABLE_PUSH               2
#define CO_HTTP2_SETTINGS_MAX_CONCURRENT_STREAMS    3
#define CO_HTTP2_SETTINGS_INITIAL_WINDOW_SIZE       4
#define CO_HTTP2_SETTINGS_MAX_FRAME_SIZE            5
#define CO_HTTP2_SETTINGS_MAX_HEADER_LIST_SIZE      6
...
typedef struct
{
    ...
    co_http2_setting_param_t* params;
...
co_http2_frame_t* co_http2_create_settings_frame(
    bool ack, const co_http2_setting_param_t* params, uint16_t param_count);
...
co_http2_frame_t* co_http2_create_push_promise_frame(
    ...
    const uint8_t* header_block_fragment,
    uint32_t header_block_fragment_length,
    uint8_t* padding, uint8_t pad_length);
