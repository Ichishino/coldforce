...
#define CO_NET_EVENT_ID_TCP_SEND_ASYNC_READY    0x7103
#define CO_NET_EVENT_ID_TCP_SEND_ASYNC_COMPLETE 0x7104
#define CO_NET_EVENT_ID_TCP_RECEIVE_READY       0x7105
#define CO_NET_EVENT_ID_TCP_CLOSE               0x7106
#define CO_NET_EVENT_ID_TCP_ACCEPT_ON_THREAD    0x7107

#define CO_NET_EVENT_ID_UDP_SEND_ASYNC_READY    0x7111
#define CO_NET_EVENT_ID_UDP_SEND_ASYNC_COMPLETE 0x7112
