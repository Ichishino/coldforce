...
void co_udp_on_send_complete(co_udp_t* udp, size_t data_length);
void co_udp_on_receive_ready(co_udp_t* udp, size_t data_length);
...
CO_NET_API bool co_udp_send_string(co_udp_t* udp,
...
#ifdef CO_OS_WIN
CO_NET_API size_t co_win_udp_get_receive_data_length(const co_udp_t* udp);
